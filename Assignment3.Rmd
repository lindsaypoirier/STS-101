...
scorecard %>% 
  _____((_____ %in% c(_____, _____)) & (_____ _____ _____)) %>% #%in% tests whether the value in a given row matches the values listed in c(__,__) Hint: Here you will fill in the same values in your "or" statement above
  _____(_____) %>%
  _____(total = _____)
```
...
scorecard %>% 
  _____(_____) %>%
  ____(_____ _____ _____(_____, na.rm = TRUE)) %>%
  _____ %>%
  _____(_____, _____, _____, _____)
